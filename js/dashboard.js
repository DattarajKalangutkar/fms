(function($) {
    ...
    $(function() {
        ...
        //  Added Jquery for dashboard ---> Rama (Start)
        ...
        if ($("#status-summary3").length) {
            var statusSummaryChartCanvas = document.getElementById("status-summary3").getContext('2d');;
            var statusData = {
                labels: ["SUN", "MON", "TUE", "WED", "THU", "FRI"],
                datasets: [{
                    label: '# of Votes',
        ...
        if ($("#status-summary4").length) {
            var statusSummaryChartCanvas = document.getElementById("status-summary4").getContext('2d');;
            var statusData = {
                labels: ["SUN", "MON", "TUE", "WED", "THU", "FRI"],
                datasets: [{
                    label: '# of Votes',
        ...
        if ($("#status-summary5").length) {
            var statusSummaryChartCanvas = document.getElementById("status-summary5").getContext('2d');;
            var statusData = {
                labels: ["SUN", "MON", "TUE", "WED", "THU", "FRI"],
                datasets: [{
                    label: '# of Votes',
        ...
        if ($("#status-summary6").length) {
            var statusSummaryChartCanvas = document.getElementById("status-summary6").getContext('2d');;
            var statusData = {
                labels: ["SUN", "MON", "TUE", "WED", "THU", "FRI"],
                datasets: [{
                    label: '# of Votes',
