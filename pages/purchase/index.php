                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="card-innerbody p_20">
                            <div>
                                <h4 class="card-title font22">Search Purchase</h4>
                                <p>Search by purchase details</p>
                            </div>
                            <div class="col-md-7 card p_20 search-filter">
                                ...
                                <div class="input-containers child2 focus">
                                    ...
                                    <label class="small_font" for="search_field">Search by PN# or Driver Name</label>
                                    <span>Search by PN# or Driver Name</span>
                                </div>
                                <div id="show_filter" class="d-none">
                                    ...
                                    <div class="account_field">
                                        <div class="col-md-4 min_width pr_10">
                                            <label class="small_font" for="tag_supplier">Tag Supplier</label>
                                            <select class="js-example-basic-multiple select2-hidden-accessible custom_dropdown" name="tag_supplier" multiple="" data-select-tag_supplier-id="1" tabindex="-1" style="width:100%" aria-hidden="true" placeholder="Tag Supplier">
                                                <option value="select_all(supplies)" data-select-tag_supplier-id="1">Select All(supplies)</option>
                                                <option value="customers" data-select-tag_supplier-id="2">Customers</option>
                                                <option value="supplier" data-select-tag_supplier-id="3">Supplier</option>
                                            </select>
                                        </div>
                                        <div class="col-md-4 min_width pr_10">
                                    ...
                                    <div class="account_field">
                                        <div class="col-md-3 min_width_2 px_5">
                                            <label class="small_font" for="purchase_status">Purchase Status</label>
                                            <select class="js-example-basic-multiple select2-hidden-accessible custom_dropdown purchase_status" name="purchase_status" multiple="" data-select-purchase_status-id="" tabindex="-1" style="width:100%" aria-hidden="true" placeholder="Purchase Status">
                                                <option value="" data-select-purchase_status-id="">Purchase Status</option>
                                                <option value="all" data-select-purchase_status-id="1">All</option>
                                                <option value="current" data-select-purchase_status-id="2">Current</option>
                                                <option value="completed" data-select-purchase_status-id="3">Completed</option>
                                                <option value="inactive" data-select-purchase_status-id="4">Inactive</option>
                                                <option value="exported" data-select-purchase_status-id="5">Exported</option>
                                            </select>
                                        </div>
                                        <div class="col-md-3 min_width_2 px_5">
                            ...
                            <div class="col-md-2">
                                <a href="create.php" target="_blank" class="btn btn-primary custom_btn_resize child btn-width">+ CREATE PURCHASE</a>
                                <a href="#" class="btn btn-light custom_btn_resize child btn-width"><i class="fa fa-cloud-download-alt"></i> DOWNLOAD PURCHASE</a>
                            </div>
                        </div>
                                    ...
                                    <table id="purchase_list" class="table dataTable no-footer" aria-describedby="order-listing_info">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text_wrap px_0 sticky_col sc_1 sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1">PN #</th>
