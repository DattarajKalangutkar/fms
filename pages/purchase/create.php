      ...
      <div class="container-fluid page-body-wrapper">
         ...
         <div class="main-panel">
            <div class="content-wrapper">
               <div class="m_wrapper">
                  <h3 class="m_0">Create Purchase</h3>
                  <p class="m_0 c-grey">Enter basic details of purchase below. Fields marked * are required to fill.</p>
               </div>
                                 ...
                                 <div class="card">
                                    <div class="card-body">
                                       ...
                                       <form class="form-sample" id="myForm_2" name="myForm_2">
                                          <div class="row">
                                             <div class="">
                                                <input type="button" class="custom_btn" value="ADD PRODUCT ITEM GROUP" onclick="additemgroup();">
                                                <input type="button" class="custom_btn" value="ADD PRODUCT RETURN GROUP" onclick="addreturngroup();">
                                          ...
                                          <div class="row">
                                             ...
                                             <div class="col-12 col-md-7 item-group">
                                                   <h5>Items in Group : <span id="group_id_value"></span></h5>
                                                   <div class="item-box">
                                                      <table class="table table-light">
                                                         <thead>
                                                            <tr>
                                                         ...
                                                         <tbody id="group_items_tables">
                                                            
                                                         </tbody>
                                                      </table>
                                                   </div>
                                                   <input type="button" class="btn-light custom_btn" value="+ Add More" onclick="addmoreitemBasedongroup();">
                                             </div>
                                          </div>
                                       ...
                                       <form class="form-sample" id="myForm_5" name="myForm_5">
                                          <div class="row">
                                             <div class="">
                                                ...
                                                <div id="purchase_history_table" class="col-md-12 grid-margin stretch-card m_15rem history-list ">
                                                   <div class="card">
                                                      <div class="card-body">
                                                            <table id="purchase_history_list" class="table dataTable no-footer" aria-describedby="order-listing_info">
                                                               <thead>
                                                                  <tr>
...
<script>
   ...
   {
      var str = '';
      str += '<tr onclick="checktr('+group_id+');">';
      str += '<td>Item</td>';
      str += '<td>';
      str += '<select name="select_sku" class="form-control js-example-basic-single custom_dropdown" id="sku_group_'+group_id+'">';
      str += '<option value="0">Select SKU</option>';
      str += '<option value="mayur">Copper Grade 1 <span class="sku_unit"> - unit</span></option>';
      str += '<option value="mayur">ALUMINIUM  <span class="sku_unit"> - metric ton</span></option>';
      str += '<option value="test">Ali 1000 series  <span class="sku_unit"> - kilogram</span></option>';
      str += '</select>';
      str += '</td>';
      str += '<td>0</td>';
      str += '<td>0</td>';
      str += '<td>0</td>';
      str += '<td>0</td>';
      str += '<td><a href="#"><i class="fa fa-trash-alt"></i></a></td>';
      str += '</tr>';
      selected_group = group_id;
      document.getElementById("group_id_value").innerHTML = selected_group;
      $("#itemGroupTable").append(str);
   ...
   function checktr(id)
   {
      selected_group = id;
      document.getElementById("group_id_value").innerHTML = selected_group;
      let filter_class = "group_"+selected_group;
      $('#group_items_tables tr').hide();
      $('#group_items_tables tr.'+filter_class).show();
   }

   function addmoreitemBasedongroup()
   {
      if(document.getElementById('sku_group_'+selected_group).value == "0")
      {
         $.toast({
            heading: 'Error',
            text: 'Please Select an SKU at Group '+selected_group,
            showHideTransition: 'fade',
            icon: 'error',
            position: 'top-right',
         });
         document.getElementById('sku_group_'+selected_group).focus();
      }
      else
      {
         var str = '';
         str += '<tr id="group_'+selected_group+'_'+adding_items+'" class="group_'+selected_group+'">';
         str += '<td>';
         str += '<div class="row scale_read">';
         str += '<select name="select_sku" class="col-md-5 js-example-basic-single custom_dropdown p_10" id="">';
         str += '<option value="">Select Scale</option>';
         str += '<option value="mayur">Copper Grade 1 <span class="sku_unit"> - unit</span></option>';
         str += '<option value="mayur">ALUMINIUM  <span class="sku_unit"> - metric ton</span></option>';
         str += '<option value="test">Ali 1000 series  <span class="sku_unit"> - kilogram</span></option>';
         str += '</select>';
         str += '<div class="col-md-2 input-containers px_0 mt_18 input_field focus kg">';
         str += '<input type="text" class="input form-control" name="scale_reading" id="scale_reading" value="0" disabled>';
         str += '<label for="scale_reading">Scale Reading</label>';
         str += '</div>';
         str += '<div class="col-md-1 p_10 icon_bttn_item">';
         str += '<a href="#" id="add_scale_item"><i class="fa fa-plus"></i></a>';
         str += '</div>';
         str += '</div>';
         str += '</td>';
         str += '<td><input type="text" class="form-control weight_col" name="material_wt" id="material_wt" value="0" disabled></td>';
         str += '<td><input type="text" class="form-control weight_col" name="bag_wt" id="bag_wt" value="0"></td>';
         str += '<td><input type="text" class="form-control weight_col" name="waste_wt" id="waste_wt" value="0"></td>';
         str += '<td><input type="text" class="form-control weight_col" name="net_wt" id="net_wt" value="0" disabled></td>';
         str += '<td><a href="#"><i class="fa fa-images"></i></a></td>';
         str += '<td><a href="#"><i class="fa fa-pencil-alt"></i></a></td>';
         str += '<td><a href="#"><i class="fa fa-trash-alt"></i></a></td> ';
         str += '</tr>';
         console.log(str);
         //$("#item_group_"+selected_group).append(str);
         $("#group_items_tables").append(str);
         $(".js-example-basic-single").select2();
         adding_items++;
      }
   }
